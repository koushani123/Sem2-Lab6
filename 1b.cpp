   ...
   class linkedList //  class  containing the functions to handle the nodes
{
 ...
 if(head==NULL)  //When the list is empty
   ...
   int sortitems(int n) //Arranging the list's element in ascending order using bubblesort
...
int main() {
 ...
 l.sortitems(n);  //calling sort function to rearrange the array elements
 cout<<"\nThe sorted ";
